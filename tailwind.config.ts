	...
	theme: {
		...
		extend: {
			colors: {
				...
				magical: {
					sparkle: 'hsl(var(--magical-sparkle))',
					scroll: {
						bg: 'hsl(var(--scroll-bg))',
						border: 'hsl(var(--scroll-border))'
					}
				},
				sidebar: {
			...
			animation: {
				...
				'float-sparkle': 'float-sparkle 4s ease-in-out infinite',
